...
const AddEducationalLevelPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiMethods.post('schools/levels/', submitData);
      toast.success(t('educationalLevels.createdSuccessfully'));
  ...
  return (
    <AdminPageLayout
      title={t('educationalLevels.addEducationalLevel')}
...
export default AddEducationalLevelPage;