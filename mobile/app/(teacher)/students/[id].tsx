                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }} className="px-5 pt-2">
                    ...
                    <View className="mt-4 mb-6 items-center">
                        <View className="relative mb-4">
                            <View className={`h-28 w-28 rounded-3xl ${isDark ? 'bg-purple-500/20' : 'bg-purple-100'} items-center justify-center overflow-hidden border-2 ${isDark ? 'border-purple-400' : 'border-purple-200'} shadow-lg`}>
                    ...
                    <View className="gap-4">
                        ...
                        {student.parent_id && (
                            <View className={`rounded-3xl p-5 ${colors.cardBgColor} border ${colors.borderColor}`}>
                                ...
                                <Pressable
                                    onPress={() => router.push(`/(teacher)/parents/${student.parent_id}` as any)}
