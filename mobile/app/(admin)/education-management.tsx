        ...
        <View className="flex-1 bg-background">
            ...
            <SafeAreaView className="flex-1">
                ...
                <View className="px-6 pt-4 pb-6 flex-row items-center gap-4">
                    ...
                    <Text className={`${textColor} text-xl font-bold`}>Education Management</Text>
                </View>

                {/* Placeholder Content */}
                <View className="flex-1 items-center justify-center px-6">
                    <View className={`w-full p-8 rounded-3xl ${cardBg} border ${cardBorder} items-center`}>
                        <View className={`w-20 h-20 rounded-full ${isDark ? 'bg-purple-500/20' : 'bg-purple-50'} items-center justify-center mb-6`}>
                            <BookOpen size={40} color={isDark ? '#c084fc' : '#a855f7'} />
                        </View>
                        <Text className={`${textColor} text-2xl font-bold mb-2`}>Education Portal</Text>
                        <Text className={`${subTextColor} text-center leading-6`}>
                            Manage lessons, exams, and grading systems.{'\n'}
